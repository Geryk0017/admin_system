<script setup>
import Edit_form from '@/components/edit_form.vue';
...
<template>
    <div>
        <div class="flex flex-col space-y-3 md:flex-row md:justify-between">
            <div class="col-span-2 flex items-center space-x-5">
                <input
                    type="text"
            ...
            <div class="grid grid-cols-2 items-center md:flex md:gap-3">
                ...
                <div class="my-5">
                    <select
                        ...
                        @change="
                            emit('update:selectedStatusApplications', $event.target.value);
                            emit('fetchApplications');
                        "
            ...
            <table class="w-full border border-gray-200 bg-white text-gray-500">
                ...
                <tbody class="text-center">
                    <tr v-if="loadingApplications">
                        <td :colspan="6" class="py-10 text-gray-500"><span class="skeleton skeleton-text">Loading Applications...</span></td>
                    </tr>

                    <tr v-else-if="!loadingApplications && filteredApplications.length === 0">
                        <td :colspan="6" class="py-10 text-gray-500">No applications found.</td>
                    </tr>
        ...
        <dialog id="my_modal_5" class="modal">
            <div class="modal-box max-w-3xl">
                ...
                <h3 class="mb-4 text-lg font-bold">View Application ID - {{ selectedApplication?.id }}</h3>
                <div class="py-4">
